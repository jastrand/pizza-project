...
const orderName = prompt('Enter the name of the pizza you want to order today! Please select either Vegetarian Pizza, Pepperoni Pizza or Hawaiian Pizza 😋');
...
const checkOrder = (order) => {
  if (order === true) {
    ...
    document.getElementById("greeting").innerHTML = `Please select a Pizza from the menu!`;
  }
}
